Employee Management SystemУчебный проект, демонстрирующий применение принципов объектно-ориентированного программирования на Java:наследование, полиморфизм, инкапсуляцию, абстрактные классы, интерфейсы и паттерн проектирования Builder.Проект выполнен в учебных целях. Конструктивная критика и предложения приветствуются.
